...
import com.github.mvysny.karibudsl.v10.getCell
...
class VaadinFiltersTest : DynaTest({
    ...
    test("grid's data provider is polled lazily on filter change") {
        ...
        filterRow.generateFilterComponents2(grid, Person::class, PredicateFilterFactory<Person>())
        ...
        val nameFilter: TextField = filterRow.getCell(Person::name).component as TextField

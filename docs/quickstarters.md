...
Vaadin components are based on the Web Components standard, with theming
driven by CSS custom properties (Lumo / Material).
...
<div onclick="location.href='https://github.com/mvysny/karibu-helloworld-application';" class="box bg-grey-dk-000"><div class="caption">UI Base</div><div class="body">A project with one view and no db; perfect for your UI experiments</div></div>
...
<div onclick="location.href='https://github.com/mvysny/beverage-buddy-ktorm';" class="box bg-green-000"><div class="caption">Full Stack App</div><div class="body">The "Beverage Buddy" app on Vaadin + Kotlin + ktorm; demoes two tables</div></div>
